...
EOF
    ...
    git commit -m 'feat!: populated from 'python-course-package' template'
    ...
    gh pr create \
        --title "feat: populated from \'python-course-package\' template" \
        --body "This PR was generated by \'python-course-package\'" \
        --base main \
